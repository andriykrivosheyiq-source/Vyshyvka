  ...
  function buildCards(offer, cfg){
    ...
    var shotsOf = function(it){
      ...
      /* Перед і спина — ЗАВЖДИ обидва, коли обидва є.
         ...
         Доти спина потрапляла на картку лише тоді, коли на ній щось
         нанесено, — інакше картка лишалась із фото моделі та одним
         ракурсом, а праворуч зяяло порожнє місце. Але клієнт дивиться на
         спину не через нанесення: він хоче побачити виріб. Чиста спина —
         це теж відповідь, і вона краща за порожнечу. */
