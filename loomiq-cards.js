...
(function(){
  ...
  var THEME = {
    /* Нейтральний шаблон — ЧИСТО БІЛИЙ. Тло в нього було ледь блакитнувате;
       на телефоні в Direct різниця з білим не читається, а картка через неї
       виглядає сіруватою, ніби недодрукованою.

       Будову тепер тримають самі плитки: кадр іде разом зі своїм студійним
       тлом, і на білому аркуші вони читаються світло-сірими блоками. Меж
       навколо них ми не малюємо навмисно — саме той кантик колись і різав
       око.

       Нішеві шаблони лишаються кольоровими: там тло працює, воно одразу
       каже, кому картка адресована. Забрати колір звідти означало б
       перетворити пʼять шаблонів на один. */
