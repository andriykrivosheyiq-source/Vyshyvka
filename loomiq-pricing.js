...
(function(){
  ...
  /* НАСКІЛЬКИ ДВА ВІДБИТКИ МАЮТЬ БУТИ СХОЖІ, ЩОБ ЦЕ БУВ ОДИН ДИЗАЙН.
     ...
     Поріг довго стояв на 3%, і це було надто строго. Той самий логотип,
     покладений окремо на дві позиції, після зняття фону дає пікселі, що
     розходяться на 5–7%: краї обрізались трохи інакше, прозорість лягла
     інакше. Рушій чесно бачив два макети, і підготовка ділилась не на весь
     тираж — 850 ÷ 3 замість 850 ÷ 5. Пояснити це менеджеру було нічим, бо
     на екрані малюнок справді один.

     Заміряно на живих макетах:
       • той самий дизайн, інший розмір ............ 0…0.1%
       • той самий дизайн, окремо знятий фон ....... 5…7%
       • різні дизайни ............................ 11…23%

     8% лишає запас в обидва боки: копії одного малюнка зводяться, різні
     малюнки не зливаються. Помилятись тут краще в бік злиття: зайвий ескіз
     у рахунку клієнт бачить і питає, а недоотриманий — ні.

     Число спільне з конструктором: інакше два примірники рушія рахували б
     те саме замовлення по-різному. */
  var FP_N = 12, FP_SAME = 0.08;
