...
/* «Сьогодні» — не ще один розділ, а вхід у роботу: дизайнер бачить у ньому
   свої макети, і рівно те, що йому й так видно на дошці.

   Третім зʼявився «Дизайн-відділ», і це свідомо: саме там тепер живе його
   робота — ТЗ, версії, причини правок. Доти дизайн був одним треком у
   Канбані, і дизайнер мусив читати картку продажу, щоб зрозуміти, що
   малювати. Решта розділів йому так само ні до чого. */
ok(board.nav.join() === 'today,board,design',
  'у меню «Сьогодні», своя дошка й дизайн-відділ — і нічого зайвого',
  'дизайнер бачить не ті розділи: ' + board.nav.join(','));
