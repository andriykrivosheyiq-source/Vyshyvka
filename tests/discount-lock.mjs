...
const ЕТАЛОН = [
  { назва:'Футболка базова', сегмент:'склад',    ціна:880, було:1720, знижка:49 },
  /* Варіант і рекомендована рахуються як «склад + ЦЕЙ», тож у них тираж 10 і
     коефіцієнт 0.81, а макет ділиться на 10. Базова йде в складі сама — тираж
     5, коефіцієнт 0.85, макет на 5. Те, що поло вийшло рівно як базова, —
     збіг: дорожчий виріб і нижчий коефіцієнт зійшлись у те саме число. */
  { назва:'Футболка поло',   сегмент:'варіант',  ціна:880, було:1870, знижка:53 },
  { назва:'Футболка оверсайз', сегмент:'варіант',ціна:823, було:1800, знижка:54 },
  { назва:'Кепка',           сегмент:'реко',     ціна:782, було:1750, знижка:55 }
];
