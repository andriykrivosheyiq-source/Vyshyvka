...
/* Еталон переписаний удруге, і теж свідомо. Дві причини, обидві — виправлення.
   ...
   нанесення 0.81 і коефіцієнт виробу 0.92 діють на всіх; рекомендована
   рахується «склад + вона», тобто на 15. */
const ЕТАЛОН = [
  ...
  { назва:'Кепка',           сегмент:'реко',     ціна:822, було:1750, знижка:53 }
];
