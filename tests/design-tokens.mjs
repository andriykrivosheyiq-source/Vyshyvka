...
const R0 = rules(css);
/* Режим знімка (?shot=1) — не екранна сторінка, а один кадр 1200×630 для
   заставки посилання. Там свій кегль і свої відступи: обкладинка на телефоні
   набрана під 390 px завширшки, і на втричі більшому кадрі ті самі числа
   дали б марку в кутку. До шкали сторінки цей режим стосунку не має. */
const R = R0.filter(r => !/\bis-shot\b/.test(r.sel));
