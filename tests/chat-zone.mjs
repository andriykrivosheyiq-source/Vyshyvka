...
console.log('');
console.log('═══ РОЗМОВА З ДОШКИ — НА ВСЮ ШИРИНУ ═══');
/* Картки немає, тож лишати під неї порожню смугу справа немає сенсу. */
await p.evaluate(() => chatOpen(orders[0], 'tg'));
...
ok(solo.chat && solo.chat.r > vw - 40,
   'без картки зона дотягується до правого краю',
   'лишилась порожня смуга під картку, якої немає: ' +
