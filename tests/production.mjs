...
/* У виробництва одна дошка — «Виробництво». Тест і контроль окремих дошок
   більше не мають: у B2B їх рівно шість, і під ці два треки немає окремої
   людини. Кроки лишились у картці, і саме там їх і проставляють. */
ok(board.sw.length === 1 && /Виробництво/.test(board.sw[0] || ''),
  'у виробництва своя дошка — «Виробництво», і в перемикачі більше нічого',
  'дошки не ті: ' + board.sw.join(' | '));
ok(board.cols.join() === 'Заблоковано,Готово до тиражу,У виробництві,Готово',
  'і колонки на ній виробничі',
  'колонки не ті: ' + board.cols.join(' · '));
/* «Сьогодні» показує виробництву його ж роботу — тести, тираж, контроль. */
ok(board.nav.join() === 'today,board',
  'у меню лише «Сьогодні» й свої дошки',
