...
ok(names[0] === 'Як проходитиме замовлення' &&
  ...
  'у згортках усе: процес, гарантії, умови й проєкти',
...
ok(e.рядки.length === 3 && /Умови/.test(e.рядки[2].назва),
  'лишились процес, гарантії й умови — вони не залежать від цієї пропозиції',
