...
ok(/function specCols/.test(src0) && /eyebrow\(x, 'Про товар'/.test(src0),
  'характеристики йдуть у дві колонки під заголовком «Про товар»',
  'колонок немає або заголовок старий');
