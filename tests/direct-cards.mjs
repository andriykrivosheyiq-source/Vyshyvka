...
ok(порівняння && порівняння.рядівКадрів === 2,
  'сторони виробу — теж рядки: «Спереду» одним, «Ззаду» другим',
  'сторони не стали рядами: ' + JSON.stringify(порівняння));
console.log('   один ракурс: ' + порівняння.w1 + '×' + порівняння.h1 +
            ' · два: ' + порівняння.w + '×' + порівняння.h);
ok(порівняння && порівняння.w === порівняння.w1 && порівняння.h > порівняння.h1,
  'другий ракурс додає картці ВИСОТИ, а не ширини — саме від ширини залежить, чи буде видно на телефоні',
  'картка розповзлась убік: ' + порівняння.w1 + '×' + порівняння.h1 +
    ' → ' + порівняння.w + '×' + порівняння.h);
