   ...
   мовчить». Читається як у месенджері, тож пояснювати нічого не треба. */
{
  ...
  const кс = adm.slice(adm.indexOf('.tc-act--kp{'), adm.indexOf('.tc-act--kp{') + 220);
  ok(/background:var\(--ink\)/.test(кс) && /color:#fff/.test(кс),
    'кнопка чорна — у ряду однакових сірих вона губилась',
    'кнопка лишилась світлою');
}
