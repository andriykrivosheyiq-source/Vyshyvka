    ...
    return new Promise(function(res){
      ...
      img.onload = function(){
        try{
          ...
          res(imageFingerprint(img, m ? m.opaqueBox : null));
        }catch(e){ res(''); }
      };
      // Картинка не відкрилась (адреса померла, домен без CORS) — краще
      // порожній відбиток, ніж вигаданий: порожній рушій приєднає до
      // першої групи й не виставить ескізу за роботу, якої не бачив.
