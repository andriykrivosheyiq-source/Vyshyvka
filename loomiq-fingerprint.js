...
(function(){
  ...
  // той самий дизайн з окремо знятим фоном — 5…7%, різні дизайни — 11…23%.
  // Поріг 8% зводить копії й не зливає різні; сам поріг живе в рушії цін
  // (loomiq-pricing.js), бо рішення про гроші ухвалює він.
  var FP_N = 12;
